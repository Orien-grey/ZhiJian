...
.overlay {
  ...
  background:
    ...
    radial-gradient(ellipse 500px 350px at 80% 100%, rgba(0, 212, 255, 0.03), transparent 70%),
    linear-gradient(180deg, #0a0f1e 0%, #070b14 100%);
  backdrop-filter: blur(20px) saturate(1.2);
  border: 1px solid rgba(0, 180, 240, 0.12);
  box-shadow:
    0 0 80px rgba(0,0,0,0.85),
    inset 0 0 0 1px rgba(0, 180, 240, 0.06),
...
.head-titles { display: flex; flex-direction: column; gap: 3px; }
.name-cn { font-size: 15px; font-weight: 700; color: #f1f5f9; letter-spacing: 0.01em; }
.name-en { font-size: 10px; color: #5a6a82; letter-spacing: 0.04em; font-weight: 500; }
...
.meta-pill svg { color: #00b8e6; opacity: 0.7; }
