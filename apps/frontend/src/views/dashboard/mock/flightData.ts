...
export const MOCK_FLIGHTS: FlightItem[] = [
  ...
  { id: 'f3', flightNo: 'CZ9012', star: true, scheduledTime: '14:00', depIcao: 'ZGGG', depName: '广州', arrIcao: 'ZUUU', arrName: '成都', estimatedTime: '16:30', status: 'dispatched', statusLabel: '签派', countdown: '00:15', isAffected: true, isCompanyRoute: false, aircraftType: 'A330', registration: 'B-9012' },
