...
export const MOCK_FLIGHTS: FlightItem[] = [
  // ---- 上午时段（06:00-10:00）已起飞/在飞 ----
  { id:'f01', flightNo:'CA1501', star:false,  scheduledTime:'06:30', depIcao:'ZBAA', depName:'北京', arrIcao:'ZSSS', arrName:'上海虹桥', estimatedTime:'08:50', status:'in_flight',  statusLabel:'在飞', countdown:'00:55', isAffected:false, isCompanyRoute:true,  aircraftType:'A359', registration:'B-32DM' },
  ...
  { id:'f06', flightNo:'3U8701', star:false,  scheduledTime:'08:30', depIcao:'ZUCK', depName:'重庆', arrIcao:'ZGGG', arrName:'广州白云', estimatedTime:'10:15', status:'landing',    statusLabel:'即将降落', countdown:'00:12', isAffected:false, isCompanyRoute:true,  aircraftType:'A320', registration:'B-8680' },
  { id:'f07', flightNo:'MU5201', star:true, scheduledTime:'08:55', depIcao:'ZSSS', depName:'上海', arrIcao:'ZGGG', arrName:'广州白云', estimatedTime:'11:15', status:'in_flight',  statusLabel:'在飞', countdown:'01:30', isAffected:true,  isCompanyRoute:true,  aircraftType:'B738', registration:'B-5801' },
  ...
  // ---- 下午时段（13:00-17:00） ----
  { id:'f21', flightNo:'CA1507', star:true,  scheduledTime:'13:30', depIcao:'ZBAA', depName:'北京', arrIcao:'ZSSS', arrName:'上海虹桥', estimatedTime:'15:50', status:'in_flight',  statusLabel:'在飞', countdown:'01:20', isAffected:true,  isCompanyRoute:true,  aircraftType:'B77W', registration:'B-7953' },
  { id:'f22', flightNo:'CZ3601', star:true, scheduledTime:'13:45', depIcao:'ZGGG', depName:'广州', arrIcao:'ZUUU', arrName:'成都双流', estimatedTime:'16:10', status:'in_flight',  statusLabel:'在飞', countdown:'01:35', isAffected:true,  isCompanyRoute:false, aircraftType:'A330', registration:'B-6107' },
  ...
  { id:'f49', flightNo:'HU7701', star:true, scheduledTime:'22:00', depIcao:'ZSPD', depName:'浦东', arrIcao:'ZUUU', arrName:'成都双流', estimatedTime:'00:50', status:'planned',    statusLabel:'计划', countdown:'02:05', isAffected:true,  isCompanyRoute:false, aircraftType:'B788', registration:'B-2760' },
